        ...
        <>
                ...
                <div className="flex flex-col space-y-8 container mx-auto p-10 md:flex-row ">
                    ...
                    <div className=" text-center space-y-10 md:ml-10 md:my-5 md:w-1/2">
                        ...
                        <p className="text-center font-semibold md:text-left md:max-w-sm">Manage provides all the functionality your team needs, without the complexity. Our software is tailor-made for modern digital product teams.</p>
                    </div>
                    {/* right item */}
                    <div className="flex flex-col space-y-6   md:w-1/2">
                        ...
                        <div className="md:ml-20">
                            <p>See how your day-to-day tasks fit into the wider vision. Go from tracking progress at the milestone level all the way down to the smallest of details. Never lose sight of the bigger picture again.</p>
                        </div>
                        <div className="bg-orange-300 rounded-l-full flex items-center md:bg-transparent md:flex-row ">
