        ...
        <>
            ...
            <div className="flex container mx-auto p-6 flex-col-reverse md:flex-row  mt-10">
                ...
                <div className="flex flex-col space-y-10  md:w-1/2">
                    ...
                    <p className="max-w-md text-center md:text-left pl-7 font-semibold">Manage makes it simple for software teams to plan day-to-day tasks while keeping the larger team goals in view.</p>
